                              ...
                              @forelse ($menu as $menus)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('menu.destroy', $menus->id) }}" method="POST">
                                            <a href="{{ route('menu.edit', $menus->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                            @csrf
                                            @method('DELETE')
